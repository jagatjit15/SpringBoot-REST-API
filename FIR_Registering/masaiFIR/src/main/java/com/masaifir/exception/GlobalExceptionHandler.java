...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ResponseErrorDetails> userExceptionHandler(UserException exception, WebRequest request){
	...
	public ResponseEntity<ResponseErrorDetails> dataErrorExceptions(DataException exception, WebRequest request){
